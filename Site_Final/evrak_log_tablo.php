...
require_once 'evrak_log_sorgu.php';
                ...
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">
                            <a href="index.html">Log Tablosu</a>
                        </li>
                        <li class="breadcrumb-item">
                            <a>Tables</a>
                        </li>
                        <li class="breadcrumb-item active">
                            <strong>Evrak Log Tablosu</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
            ...
            <div class="row">
                ...
                <div class="ibox ">
                    ...
                    <tr>
                            ...
                            <th>Yapılan İşlem<i class="fa fa-sort"></i></th>
                            </tr>
                    </thead>
                    <tbody>
                            <?php
                            ...
                            <tr>
                                <td class="deneme"><?=$logbilgi->logevrak_id?></td>
                                <td class="deneme"><?=tarihformat($logbilgi->logevrak_tarih,6)?></td>
                                <td class="deneme"><?=$logbilgi->logevrak_username?></td>
                                <td class="deneme"><?=$logbilgi->logevrak_ip?></td>
                                <td class="deneme"><?=$logbilgi->logevrak_email?></td>
                                <td class="deneme"><?=$logbilgi->logevrak_adsoyad?></td>
                                <td class="deneme"><?=$logbilgi->logevrak_evrak_adi?></td>
                                <td class="deneme"><?=$logbilgi->logevrak_islem?></td>        
                            </tr>
                            <?php } ?>
                        </tbody>
                    </table>
