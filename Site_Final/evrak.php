                ...
                <div class="sidebar-collapse">
                    <ul class="nav metismenu" id="side-menu">
                        <li class="nav-header">
                            ...
                            <li>
                                <a href="evrak_girme.php?user_id=<?=$kulid?>"><i class="fa fa-laptop"></i> <span class="nav-label">Evrak Yazma</span></a>
                            </li>
                            <?php if ($_SESSION['user_yetki'] == 1) {
                               echo '
                                <li>
        ...
        <div class="modal inmodal fade" id="myModalKisi" tabindex="-1" role="dialog"  aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                        <h4 class="modal-title">Kişi Detayları</h4>
                        <small class="font-bold"></small>
                    </div>
                    <div class="modal-body">
                        <div class="row">
            ...
            <div class="modal inmodal fade" id="modalguncelle" tabindex="-1" role="dialog"  aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button data-button-id="<?php echo $person->evrak_id ?>" type="button" class="btn btn-primary">Save changes</button>
                        </div>
                    </div>
                </div>
            </div>                                 
